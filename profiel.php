			...
			<div id="content">
				...
				<?php
					...
					while ($row = mysql_fetch_array($result))
					{
						...
						echo("<tr><td class='text'>Bedrijfnaam: </td> <td class='center'>
								<input type='text' value='" . $row['bedrijfnaam'] . "' name='bnaam'> </input>
						</td></tr>");
						echo("<tr><td class='text'>Cursus: </td> <td class='center'>
						...
						echo("<tr><td class='text'>Plaats: </td> <td class='center'>
								<input type='text' value='" . $row['plaats'] . "' name='pnaam'> </input>
						</td></tr>");
					
						echo("<table><tr><td class='center'>Datum DD-MM-YYYY</td></tr>");
						...
						echo("<tr><td>
								...
								</td><td><input type='submit' class='submit' value='Aanpassen' name='submit'></input>
						</td></tr>");
